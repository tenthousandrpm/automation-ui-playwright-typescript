...
test.describe('Settings', () => {
  ...
  test('user can update their bio', { tag: '@regression' }, async ({ authenticatedPage, settingsPage, page }) => {
    await settingsPage.goto();
  ...
  test('submit is disabled when password is too short', { tag: '@regression' }, async ({ authenticatedPage, settingsPage }) => {
    await settingsPage.goto();
  ...
  test('unauthenticated user is redirected away from settings', { tag: '@regression' }, async ({ page }) => {
